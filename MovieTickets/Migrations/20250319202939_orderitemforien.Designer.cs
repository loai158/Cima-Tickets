...
namespace MovieTickets.Migrations
{
    ...
    [Migration("20250319202939_orderitemforien")]
    partial class orderitemforien
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieTickets.ViewModels.AppUserVM", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MovieTickets.Models.Cart", b =>
                {
                    b.HasOne("MovieTickets.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MovieTickets.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("MovieTickets.Models.Order", "Order")
                        .WithOne("OrderItem")
                        .HasForeignKey("MovieTickets.Models.OrderItem", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
